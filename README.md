...
[Instagram](https://www.instagram.com/vaibhav._lll/)  

## 💻 Tech Stack:
Python | C | C++ | Java | JavaScript | HTML | CSS | MySQL | Git | GitHub | Linux | Kali Linux | Wireshark | SQL | VS Code | React | Node.js | Jupyter Notebook | Digital Forensics
